...
function LangToggle() {
  ...
  return (
    <div className="flex items-center gap-0.5 px-1.5 py-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
      {locales.map((l, i) => (
        <span key={l} className="flex items-center">
          <button
            ...
            className={cn(
              "text-xs font-semibold px-1 py-0.5 rounded transition-colors",
              locale === l
